...
{% include figure image_path="https://media.giphy.com/media/CJywPvSt4JE0E/giphy.gif" alt="this is a placeholder image" caption="" %}

Let the party begin 😹

#### Users

**NOTICE:** I suck at vue, I prolly need to do a tutorial.
{: .notice--warning}
...
- In vue, we have a `template` at the top where we define the UI.
- We, then have our js code inside a `<script></script>` tag
- Finally, we have our css inside `<style><style>` tags
